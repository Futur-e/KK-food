  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: shenggao.value,
        e: common_vendor.o(($event) => shenggao.value = $event.detail.value),
        f: common_vendor.o(tonext)
      };
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-d4882f87"], ["__file", "D:/project/zhongjie/pages/setting/setting3-3.vue"]]);
